...
<div class="row">
  <div class="col-md-6" style="margin: 20px 0px;border: 2px solid #bee1ff;border-radius: 5px;">
    <!-- Form Start For Guest Order -->
               ...
               <label class="card_payment_title">Card Expiration </label> 
                 <div class="row">
                    ...
                    <div class="col-sm-6"> 
                      ...
                      <?php $now = date('Y'); ?>
                        @for ($i = 2015; $i <= 2040; $i++)
                          <option  value="{{ $i }}" @if($now==$i) selected="selected" @endif>{{ $i }}
                          </option>
                        @endfor 
                      </select>
                    </div>
